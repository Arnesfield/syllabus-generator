...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2018 at 05:13 PM
...
(5, '{\"assigned\":{\"id\":3,\"status\":2},\"course\":1,\"remarks\":null,\"levels\":[[{\"id\":4,\"status\":2}],[{\"id\":4,\"status\":2}]]}', 3, 1531816880, 1531816880, 3);
...
(1, 'John', 'Smith', 'Doe', 'test', 'Admin', 0, '$2y$10$tEU6V/HbHOZ59TQQpUrIb.eE3enrCo5i.fYkvSKY9EPFwJJqnMh1C', '', '[]', 1, 0, 1531226010, '[\"1\"]'),
